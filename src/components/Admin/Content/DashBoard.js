        ...
        <div className="dashboard-container">
            ...
            <div className='content'>
                <div className='c-left'>
                    <div className='child'>
                        <span className='text-1'>{t('admin.DashBoard.content.sum_u')}</span>
                    ...
                    <div className='child'>
                        <span className='text-1'>{t('admin.DashBoard.content.sum_qz')}</span>
                        <span className='text-2'>
                    ...
                    <div className='child'>
                        <span className='text-1'>{t('admin.DashBoard.content.sum_qs')}</span>
                        <span className='text-2'>
                    ...
                    <div className='child'>
                        <span className='text-1'>{t('admin.DashBoard.content.sum_as')}</span>
                        <span className='text-2'>
