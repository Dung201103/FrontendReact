        ...
        <>
            <Breadcrumb className="quiz-detail-new-header">
                <Breadcrumb.Item linkAs={NavLink} linkProps={{ to: '/' }}>
                    {t('user.DetailQuiz.header.home')}
                </Breadcrumb.Item>
                <Breadcrumb.Item linkAs={NavLink} linkProps={{ to: '/users' }}>
                    {t('user.DetailQuiz.header.user')}
                </Breadcrumb.Item>
                <Breadcrumb.Item active>
                    {t('user.DetailQuiz.header.quiz')}
                </Breadcrumb.Item>
            </Breadcrumb>
            <div className="detail-quiz-container">
                <div className="left-content">
                    ...
                    <div className="footer">
                        <button className="btn btn-secondary" onClick={() => handlePrev()}>{t('user.DetailQuiz.footer.pre')}</button>
                        <button className="btn btn-primary " onClick={() => handleNext()}>{t('user.DetailQuiz.footer.nxt')}</button>
                        <button className="btn btn-warning"
                            disabled={isSubmitQuiz}
                            onClick={() => handleFinishQuiz()}>{t('user.DetailQuiz.footer.fn')}</button>
                    </div>
                </div>
                <div className="right-content">
                    <RightContent dataQuiz={dataQuiz} setIndex={setIndex} handleFinishQuiz={handleFinishQuiz} />
                </div>
                <ModalResult
